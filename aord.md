...
The reason is a phenomenon I wrote about earlier: the [fatal pinch](pinch.md). The fatal pinch is default dead + slow growth + not enough time to fix it. And the way founders end up in it is by not realizing that's where they're headed.
